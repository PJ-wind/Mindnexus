    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 px-6 text-center bg-white">
        <div className="max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-brand-50 text-brand-600 rounded-full text-xs font-medium mb-6 border border-brand-100">
            <Star className="w-3 h-3" /> Nigeria&apos;s leading virtual counselling platform
          </div>
          <h1 className="text-4xl md:text-5xl font-semibold text-gray-900 mb-5 leading-tight">
            Professional mental health support, <span className="text-brand-500">from anywhere you are</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center mb-10">
            ...
            <Link href="/auth/login" className="btn-secondary py-3 px-8 text-base">
              Browse therapists
            </Link>
          </div>
          <div className="flex flex-wrap items-center justify-center gap-6 text-sm text-gray-400">
            <div className="flex items-center gap-1.5"><CheckCircle className="w-4 h-4 text-success" /> Licensed therapists</div>
            <div className="flex items-center gap-1.5"><Clock className="w-4 h-4 text-success" /> Sessions within 24 hours</div>
            <div className="flex items-center gap-1.5"><Shield className="w-4 h-4 text-success" /> End-to-end encrypted</div>
            <div className="flex items-center gap-1.5"><Heart className="w-4 h-4 text-success" /> No judgment, no stigma</div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-sm text-gray-400 leading-relaxed">Nigeria&apos;s leading virtual counselling platform.</p>
            </div>
            {[
